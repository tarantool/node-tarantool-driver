...
TarantoolConnection.prototype.useNextReserve = function(){
    ...
    this.setState(this.states.HOST_SWITCH ,_.pick(_.assign(this.options, this.reserve[this.reserveIterator++]), ['port', 'host']));
};
...
TarantoolConnection.prototype.connect = function(){
    return new Promise(function (resolve, reject) {
        if (this.state === this.states.CONNECTING || this.state === this.states.CONNECT) {
